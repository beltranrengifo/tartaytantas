<template>
  <section>
    ...
    <floating-action
      :link="PHONE_CALL_URL"
      :position="{ bottom: '96px', right: '24px' }"
    >
      <svg
      ...
      >
        <g transform="">
          ...
          >
            <path
              d="M184.32,20.43c28.21803,0 51.2,22.98197 51.2,51.2v112.64c0,28.21803 -22.98197,51.2 -51.2,51.2h-112.64c-28.21803,0 -51.2,-22.98197 -51.2,-51.2v-112.64c0,-28.21803 22.98197,-51.2 51.2,-51.2z"
              id="strokeMainSVG"
            ></path>
          </g>
          <g
    ...
    <floating-action
      :link="WHATSAPP_URL"
      :position="{ bottom: '34px', right: '24px' }"
    >
      <svg
        class="w-4 inline"
        xmlns="http://www.w3.org/2000/svg"
...
export default Vue.extend({
  ...
  head(): object {
    return (this as any).getMetadata({
      title:
        'Tartaytantas | Las tartas favoritas de nuestros clientes de siempre',
      description:
